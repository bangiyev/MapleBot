...
FileInstall,LDli.png,%A_ScriptDir%\Assets\LD5.png,1
FileInstall,LDl.png,%A_ScriptDir%\Assets\LD6.png,1
...
gui, add, Checkbox, x15 y115 vIgnorePlayer gSubmit_All1, Ignore Player %IgnorePlayer%
...
gui, add, edit, x15 y200 w60 limit4 vCheckInterval gSubmit_All1, %CheckInterval%
...
gui, add, text, x10 y230 w220 vBotState, Status: OFF
gui, add, text, x10 y250, Version: 1.0.2 ; updated eboss detect + ignore
...
_Check_LD() {
  ImageSearch, LD5X, LD5Y,1,1,1920,1080, *1 LD5.png ;unsure if either of these will be detected so using 2 options isntead of 1
  ImageSearch, LD6X, LD6Y,1,1,1920,1080, *1 LD6.png
  if(LD5X || LD6X) {
